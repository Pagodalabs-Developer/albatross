  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-ring border-border-subtle shadow-card has-focus:ring-ring/50 has-focus:ring-[3px] relative rounded-button border",
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-meta font-normal",
        ...
        week_number: cn(
          "text-muted-foreground select-none text-meta",
